...
public class RecommenderMapper extends
    ...
    public void map(IntWritable otherId, VectorWritable otherRatings,
        ...
        //double sim = VectorUtils.cosineSimilarity(myRatings, otherRatings);
        String str =otherRatings.toString().replace("{","");
        str =str.replace("}","");
        str =str.replace(",", "\t");
     ...
     double sim = VectorUtils.cosineSimilarity(myRatings, vector);
     //System.err.println(sim);
     outputValue.set(sim, vector);
